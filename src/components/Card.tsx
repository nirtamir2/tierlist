...
export function Card(props: Props) {
  return (
    <div class="group/card relative flex h-36 flex-col justify-between overflow-hidden rounded-md border border-gray-900 bg-transparent shadow-inner shadow-white transition duration-300 hover:bg-white/20">
